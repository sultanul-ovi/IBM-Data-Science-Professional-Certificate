...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown', options=site_options, value='ALL', placeholder="place holder here", searchable=True),
                                html.Br(),
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        # data = filtered_df.groupby('class').count().reset_index(drop=True)
